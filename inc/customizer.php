...
function mars_customizer_settings( $wp_customize ) {
  ...
  $wp_customize->add_section( 'mars_frontpage_section_one' , array(
    ...
    'priority'   => 30,
    'panel'  => 'panel_front_page',
    'description'    => __('Manage the content in section one of the front page.<br><br><strong>For your first edit, you may not see your changes until you save and refresh this page.</strong>', 'mars'),
  ) );
  ...
  $wp_customize->add_section( 'mars_frontpage_section_two' , array(
    ...
    'priority'   => 30,
    'panel'  => 'panel_front_page',
    'description'    => __('Manage the content in section two of the front page.<br><br><strong>For your first edit, you may not see your changes until you save and refresh this page.</strong>', 'mars'),
  ) );
 ...
 // Create section for advanced options.
  $wp_customize->add_section( 'mars_frontpage_advanced' , array(
    ...
    'priority'   => 30,
    'panel'  => 'panel_front_page',
    'description'    => __('Using HTML, create custom content for your front page. For a completely custom front page, you can hide section one, section two, and the hero image by setting their display option to "Hide".<br><br><strong>For your first edit, you may not see your changes until you save and refresh this page.</strong>', 'mars'),
  ) );
